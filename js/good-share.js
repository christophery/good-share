(function () {
	...
	var email_icon = '<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16"><title>Untitled-1</title><rect x="0.5" y="0.5" width="19" height="15" rx="1.609" fill="#fff" stroke="#000" stroke-miterlimit="10"/><polyline points="17.124 3.13 13.562 5.565 10 8 6.438 5.565 2.876 3.13" fill="none" stroke="#000" stroke-miterlimit="10"/></svg>';
